...
import static net.stardomga.stardoms_colors.block.ModBlocks.CONCRETE_SLAB;
import static net.stardomga.stardoms_colors.block.ModBlocks.CONCRETE_STAIR;

public class ConcreteStairBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public ConcreteStairBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.CONCRETE_STAIR, pos, state);
    }
    ...
    public ItemStack getColoredDrop(int amnt) {
        ItemStack stack = new ItemStack(CONCRETE_STAIR.asItem());
        stack.setCount(amnt);
