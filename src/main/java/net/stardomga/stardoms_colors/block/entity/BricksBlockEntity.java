...
public class BricksBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public BricksBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.BRICKS, pos, state);
    }
    ...
    public ItemStack getColoredDrop() {
        ItemStack stack = new ItemStack(BRICKS.asItem());
