...
public class TerracottaBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public TerracottaBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.TERRACOTTA, pos, state);
    }
    ...
    public ItemStack getColoredDrop() {
        ItemStack stack = new ItemStack(ModBlocks.TERRACOTTA.asItem());
