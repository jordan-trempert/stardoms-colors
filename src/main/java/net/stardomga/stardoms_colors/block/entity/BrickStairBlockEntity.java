...
import static net.stardomga.stardoms_colors.block.ModBlocks.BRICK_SLAB;
import static net.stardomga.stardoms_colors.block.ModBlocks.BRICK_STAIR;

public class BrickStairBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public BrickStairBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.BRICK_STAIR, pos, state);
    }
    ...
    public ItemStack getColoredDrop(int amnt) {
        ItemStack stack = new ItemStack(BRICK_STAIR.asItem());
        stack.setCount(amnt);
