...
public class TerracottaSlabBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public TerracottaSlabBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.TERRACOTTA_SLAB, pos, state);
    }
    ...
    public ItemStack getColoredDrop(int amnt) {
        ItemStack stack = new ItemStack(TERRACOTTA_SLAB.asItem());
        stack.setCount(amnt);
