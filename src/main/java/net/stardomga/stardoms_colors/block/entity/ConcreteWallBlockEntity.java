...
public class ConcreteWallBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public ConcreteWallBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.CONCRETE_WALL, pos, state);
    }
