...
public class BrickWallBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public BrickWallBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.BRICK_WALL, pos, state);
    }
