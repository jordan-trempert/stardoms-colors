...
public class ConcreteBlockEntity extends BlockEntity {
    ...
    public ConcreteBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.CONCRETE, pos, state);
    }
    ...
    public ItemStack getColoredDrop() {
        ItemStack stack = new ItemStack(CONCRETE.asItem());
