...
import static net.stardomga.stardoms_colors.block.ModBlocks.CANDLE;
...
public class CandleBlockEntity extends BlockEntity {
    ...
    public CandleBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.CANDLE, pos, state);
    }
    ...
    public ItemStack getColoredDrop() {
        ItemStack stack = new ItemStack(CANDLE.asItem());
