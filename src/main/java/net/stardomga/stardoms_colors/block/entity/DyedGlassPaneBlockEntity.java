...
import static net.stardomga.stardoms_colors.block.ModBlocks.DYED_GLASS;
import static net.stardomga.stardoms_colors.block.ModBlocks.DYED_GLASS_PANE;

public class DyedGlassPaneBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public DyedGlassPaneBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.DYED_GLASS_PANE, pos, state);
    }
    ...
    public ItemStack getColoredDrop() {
        ItemStack stack = new ItemStack(DYED_GLASS_PANE.asItem());
