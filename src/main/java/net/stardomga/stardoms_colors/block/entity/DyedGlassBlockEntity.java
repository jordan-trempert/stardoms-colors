...
public class DyedGlassBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public DyedGlassBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.DYED_GLASS, pos, state);
    }
    ...
    public ItemStack getColoredDrop() {
        ItemStack stack = new ItemStack(DYED_GLASS.asItem());
