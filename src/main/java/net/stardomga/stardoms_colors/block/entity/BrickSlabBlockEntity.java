...
public class BrickSlabBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public BrickSlabBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.BRICK_SLAB, pos, state);
    }
    ...
    public ItemStack getColoredDrop(int amnt) {
        ItemStack stack = new ItemStack(BRICK_SLAB.asItem());
        stack.setCount(amnt);
