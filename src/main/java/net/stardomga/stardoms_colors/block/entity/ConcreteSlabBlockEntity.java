...
import static net.stardomga.stardoms_colors.block.ModBlocks.CONCRETE;
import static net.stardomga.stardoms_colors.block.ModBlocks.CONCRETE_SLAB;

public class ConcreteSlabBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public ConcreteSlabBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.CONCRETE_SLAB, pos, state);
    }
    ...
    public ItemStack getColoredDrop(int amnt) {
        ItemStack stack = new ItemStack(CONCRETE_SLAB.asItem());
        stack.setCount(amnt);
