...
public class TerracottaWallBlockEntity extends BlockEntity {
    public int color = 0xFFFFFF;


    public TerracottaWallBlockEntity(BlockPos pos, BlockState state) {
        super(StardomsColorsBlockEntityTypes.TERRACOTTA_WALL, pos, state);
    }
