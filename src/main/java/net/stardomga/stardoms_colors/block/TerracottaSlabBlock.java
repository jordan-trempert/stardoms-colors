...
public class TerracottaSlabBlock extends SlabBlock implements BlockEntityProvider {
    public TerracottaSlabBlock(Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new TerracottaSlabBlockEntity(pos, state);
    }
    ...
    */
    ...
    protected ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state, boolean includeData) {
        if (world.getBlockEntity(pos) instanceof TerracottaSlabBlockEntity be) {
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (world.getBlockEntity(pos) instanceof TerracottaSlabBlockEntity coloredBE && player.getMainHandStack().isSuitableFor(Blocks.STONE.getDefaultState())) {
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        if (world.getBlockEntity(pos) instanceof TerracottaSlabBlockEntity coloredBE) {
    ...
    protected ActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (stack.getItem() instanceof DyeItem dyeItem) {
            if (world.getBlockEntity(pos) instanceof TerracottaSlabBlockEntity colorBlockEntity) {
