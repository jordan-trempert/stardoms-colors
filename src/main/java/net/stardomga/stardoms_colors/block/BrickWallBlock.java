...
import net.stardomga.stardoms_colors.block.entity.BrickWallBlockEntity;
import org.jetbrains.annotations.Nullable;

public class BrickWallBlock extends WallBlock implements BlockEntityProvider {


    public BrickWallBlock(Settings settings) {
        super(settings);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new BrickWallBlockEntity(pos, state);
    }
    ...
    */
    ...
    protected ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state, boolean includeData) {
        if (world.getBlockEntity(pos) instanceof BrickWallBlockEntity be) {
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (world.getBlockEntity(pos) instanceof BrickWallBlockEntity coloredBE && player.getMainHandStack().isSuitableFor(Blocks.STONE.getDefaultState())) {
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        if (world.getBlockEntity(pos) instanceof BrickWallBlockEntity coloredBE) {
    ...
    protected ActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (stack.getItem() instanceof DyeItem dyeItem) {
            if (world.getBlockEntity(pos) instanceof BrickWallBlockEntity colorBlockEntity) {
