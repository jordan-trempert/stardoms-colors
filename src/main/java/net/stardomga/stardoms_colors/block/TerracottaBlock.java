...
public class TerracottaBlock extends BlockWithEntity {
    public TerracottaBlock(Settings settings) {
        super(settings);
    }

    @Override
    protected MapCodec<? extends TerracottaBlock> getCodec() {
        return createCodec(TerracottaBlock::new);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new TerracottaBlockEntity(pos, state);
    }
    ...
    */
    ...
    protected ActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (stack.getItem() instanceof DyeItem dyeItem) {
            if (world.getBlockEntity(pos) instanceof TerracottaBlockEntity colorBlockEntity) {
    ...
    protected ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state, boolean includeData) {
        if (world.getBlockEntity(pos) instanceof TerracottaBlockEntity be) {
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (world.getBlockEntity(pos) instanceof TerracottaBlockEntity coloredBE) {
